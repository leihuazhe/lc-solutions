...
# source:  https://leetcode-cn.com/problems/apply-operations-to-an-array
...
integers. 
 ...
 You need to apply n - 1 operations to this array where, in the iᵗʰ operation (0
-indexed), you will apply the following on the iᵗʰ element of nums: 
...
Explanation: No operation can be applied, we just shift the 0 to the end.
 ...
 Related Topics Array Two Pointers Simulation 👍 535 👎 25
...
if __name__ == '__main__':
    s = Solution()
    # print(s.applyOperations([1, 1, 2, 1, 1, 0]))
